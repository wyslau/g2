function [IND, D] = nearestpointDBH(x, y, m, k) 
% NEARESTPOINT - find the nearest value in another vector
% 
% Modifed by WSL and DBH to search for kth order nearest point (only works
% for next/previous, not for nearest.
%
% nearestpoint returns all differences as absolute values
%
